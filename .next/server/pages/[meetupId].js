...
async function getStaticPaths() {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://mitol5549:s5dV7PQTj1s9ZBvo@cluster0.8laixvg.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
...
async function getStaticProps(content) {
